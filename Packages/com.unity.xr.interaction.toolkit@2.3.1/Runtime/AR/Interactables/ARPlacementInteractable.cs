...
namespace UnityEngine.XR.Interaction.Toolkit.AR
{
    ...
    public partial class ARPlacementInteractable : ARBaseGestureInteractable
    {
        ...
        public GameObject m_PlacementPrefab;
        ...
        public LayerMask m_FallbackLayerMask;
        ...
        public ARObjectPlacementEventArgs m_ObjectPlacementEventArgs = new ARObjectPlacementEventArgs();

        public List<ARRaycastHit> s_Hits = new List<ARRaycastHit>();

        public Pose curpose { get; set; }
...
#pragma warning restore 618
            ...
            {
                var placementObject = PlaceObject(curpose);
